...
const DEFAULT_SEED_CONVERSATIONS: Conversation[] = [
  {
    id: 'conv-july-1',
    title: 'Talwar College: Engineering & CS degrees',
    userId: 'demo_user_123',
    createdAt: new Date('2026-07-28T10:00:00Z').getTime(),
    updatedAt: new Date('2026-07-28T10:00:00Z').getTime(),
    lastMessage: 'Explored Computer Science and ABET-accredited engineering programs.',
  },
  {
    id: 'conv-july-2',
    title: 'International Student I-20 & Visa Guide',
    userId: 'demo_user_123',
    createdAt: new Date('2026-07-20T14:30:00Z').getTime(),
    updatedAt: new Date('2026-07-20T14:30:00Z').getTime(),
    lastMessage: 'Detailed TOEFL 70/IELTS 6.0 and Form I-20 verification checklist.',
  },
  {
    id: 'conv-july-3',
    title: 'Tuition Breakdown & Merit Scholarships',
    userId: 'demo_user_123',
    createdAt: new Date('2026-07-15T09:15:00Z').getTime(),
    updatedAt: new Date('2026-07-15T09:15:00Z').getTime(),
    lastMessage: 'Overview of $16,436/semester tuition and $18,000/yr international merit awards.',
  },
  {
    id: 'conv-june-1',
    title: 'College of Business: MBA & Leadership',
    userId: 'demo_user_123',
    createdAt: new Date('2026-06-25T11:00:00Z').getTime(),
    updatedAt: new Date('2026-06-25T11:00:00Z').getTime(),
    lastMessage: 'Overview of MBA management tracks and Ph.D. in Global Leadership.',
  },
  {
    id: 'conv-june-2',
    title: 'Campus Life & Fort Wayne Location',
    userId: 'demo_user_123',
    createdAt: new Date('2026-06-18T16:45:00Z').getTime(),
    updatedAt: new Date('2026-06-18T16:45:00Z').getTime(),
    lastMessage: '1600 E Washington Blvd campus facilities and student housing info.',
  },
  {
    id: 'conv-june-3',
    title: 'Indiana Tech Warriors: NAIA Athletics',
    userId: 'demo_user_123',
    createdAt: new Date('2026-06-05T08:20:00Z').getTime(),
    updatedAt: new Date('2026-06-05T08:20:00Z').getTime(),
    lastMessage: 'Overview of WHAC conference sports teams and Maximus mascot.',
  },
  {
    id: 'conv-may-1',
    title: 'College of Professional Studies: Online',
    userId: 'demo_user_123',
    createdAt: new Date('2026-05-22T19:10:00Z').getTime(),
    updatedAt: new Date('2026-05-22T19:10:00Z').getTime(),
    lastMessage: '100% online accelerated degree options for working adults.',
  },
  {
    id: 'conv-may-2',
    title: 'Undergraduate Rolling Admissions Process',
    userId: 'demo_user_123',
    createdAt: new Date('2026-05-14T13:00:00Z').getTime(),
    updatedAt: new Date('2026-05-14T13:00:00Z').getTime(),
    lastMessage: 'Free online application guidelines and transcript submission.',
  },
  {
    id: 'conv-may-3',
    title: 'President Dr. Karl W. Einolf & Leadership',
    userId: 'demo_user_123',
    createdAt: new Date('2026-05-02T18:00:00Z').getTime(),
    updatedAt: new Date('2026-05-02T18:00:00Z').getTime(),
    lastMessage: 'University history since 1930 and executive leadership overview.',
  },
]
